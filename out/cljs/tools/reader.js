...
var G__4408 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__4408;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4409 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4409,ch);
...
if(("\\" === ch__$1)){
var ch_4410__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4410__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4410__$2);
} else {
}

var G__4411 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4411;
continue;
}
}
...
var vec__4419 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4419,(0),null);
var start_column = cljs.core.nth.call(null,vec__4419,(1),null);
...
var G__4422 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4422;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__4423 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__4424 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__4424;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__4423;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4425 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4425,(0),null);
var start_column = cljs.core.nth.call(null,vec__4425,(1),null);
...
var vec__4428 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4428,(0),null);
var end_column = cljs.core.nth.call(null,vec__4428,(1),null);
...
var vec__4431 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4431,(0),null);
var start_column = cljs.core.nth.call(null,vec__4431,(1),null);
...
var vec__4434 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4434,(0),null);
var end_column = cljs.core.nth.call(null,vec__4434,(1),null);
...
var vec__4437 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4437,(0),null);
var start_column = cljs.core.nth.call(null,vec__4437,(1),null);
...
var vec__4440 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4440,(0),null);
var end_column = cljs.core.nth.call(null,vec__4440,(1),null);
...
var sb = (function (){var G__4443 = (new goog.string.StringBuffer());
G__4443.append(initch);
...
var G__4445 = (function (){var G__4444 = sb;
G__4444.append(ch);

return G__4444;
})();
var G__4446 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4445;
ch = G__4446;
continue;
}
...
switch (G__4449) {
case "\\":
var G__4453 = (function (){var G__4450 = sb;
G__4450.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4450;
})();
var G__4454 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4453;
ch = G__4454;
continue;
...
break;
default:
var G__4455 = (function (){var G__4451 = sb;
G__4451.append(ch);

return G__4451;
})();
var G__4456 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4455;
ch = G__4456;
continue;
...
var vec__4457 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4457,(0),null);
var end_column = cljs.core.nth.call(null,vec__4457,(1),null);
...
var vec__4460 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4460,(0),null);
var column = cljs.core.nth.call(null,vec__4460,(1),null);
...
var vec__4465 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4465,(0),null);
var column = cljs.core.nth.call(null,vec__4465,(1),null);
...
var vec__4470 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4470,(0),null);
var column = cljs.core.nth.call(null,vec__4470,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4475 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4475,(0),null);
var start_column = cljs.core.nth.call(null,vec__4475,(1),null);
...
var vec__4478 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4478,(0),null);
var end_column = cljs.core.nth.call(null,vec__4478,(1),null);
...
var G__4481 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4481,true,null,opts,pending_forms);
...
var G__4482 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4482)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4482)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4482)){
...
var _STAR_suppress_read_STAR__orig_val__4483 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4484 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4484;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4483;
}});
...
var G__4485 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4485,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4485,rdr,first_line);
...
var G__4489 = matched;
var G__4490 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4489;
finished = G__4490;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__4491 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4492 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4492;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4491;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__4493 = cljs.tools.reader.arg_env;
var arg_env_temp_val__4494 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__4494;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4495 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4495,"(");
...
var G__4496 = (i + (1));
var G__4497 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__4493;
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4498 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4498);
...
var G__4499 = cljs.core.next.call(null,s__$1);
var G__4500 = ret;
s__$1 = G__4499;
r = G__4500;
continue;
...
var G__4502 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4501;
key_vals = G__4502;
continue;
} else {
...
var gensym_env_orig_val__4506 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__4507 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__4507;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__4506;
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4508 = token;
var G__4508__$1 = (((G__4508 == null))?null:cljs.core.subs.call(null,G__4508,(1)));
var G__4508__$2 = (((G__4508__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4508__$1));
var G__4508__$3 = (((G__4508__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4508__$2));
var G__4508__$4 = (((G__4508__$3 == null))?null:cljs.core.symbol.call(null,G__4508__$3));
if((G__4508__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4508__$4);
}
})():(function (){var G__4509 = token;
var G__4509__$1 = (((G__4509 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4509));
if((G__4509__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4509__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4520,reader){
...
var opts = map__4521__$1;
var eof = cljs.core.get.call(null,map__4521__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));

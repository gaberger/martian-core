...
var G__6224 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__6224,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__6224;
}
});
...
var len__4730__auto___6229 = arguments.length;
var i__4731__auto___6230 = (0);
while(true){
if((i__4731__auto___6230 < len__4730__auto___6229)){
args__4736__auto__.push((arguments[i__4731__auto___6230]));

var G__6231 = (i__4731__auto___6230 + (1));
i__4731__auto___6230 = G__6231;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq6226){
var G__6227 = cljs.core.first.call(null,seq6226);
var seq6226__$1 = cljs.core.next.call(null,seq6226);
var G__6228 = cljs.core.first.call(null,seq6226__$1);
var seq6226__$2 = cljs.core.next.call(null,seq6226__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6227,G__6228,seq6226__$2);
});
...
var file = cljs.core.get.call(null,map__6233__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__6233__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__6233__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__6233,map__6233__$1,file,line,column){
return (function (p1__6232_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__6232_SHARP_));
});})(map__6233,map__6233__$1,file,line,column))
...
var temp__5735__auto___6235 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___6235)){
var message_6236 = temp__5735__auto___6235;
...
var temp__5735__auto___6237 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___6237)){
var message_6238 = temp__5735__auto___6237;
cljs.core.println.call(null,message_6238);
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__6239 = output_dir;
...
var G__6241 = exception.stack;
var G__6241__$1 = (((G__6241 == null))?null:clojure.string.split_lines.call(null,G__6241));
var G__6241__$2 = (((G__6241__$1 == null))?null:cljs.core.get.call(null,G__6241__$1,depth));
if((G__6241__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__6241__$2);
}
} else {
...
var vec__6242 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__6242,(0),null);
var column = cljs.core.nth.call(null,vec__6242,(1),null);
var vec__6245 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__6245,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__6245,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__6245,(2),null);
...
var m__$1 = (function (){var G__6248 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__6252 = (function (){var G__6251 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__6251);
} else {
return G__6251;
}
})();
...
return cljs.core.vary_meta.call(null,G__6253,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__6255 = e;
var G__6255__$1 = (((G__6255 instanceof cljs.core.Keyword))?G__6255.fqn:null);
switch (G__6255__$1) {
...
var vec__6257 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__6257,(0),null);
var types = vec__6257;
...
return cljs.core.map.call(null,(function (p__6260){
var vec__6261 = p__6260;
var ns = cljs.core.nth.call(null,vec__6261,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__6261,(1),null);
return ((function (vec__6261,ns,vars__$1){
return (function (){
...
var G__6264 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__6264__$1 = (((G__6264 instanceof cljs.core.Keyword))?G__6264.fqn:null);
switch (G__6264__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__6264,G__6264__$1,env,once_fixtures,each_fixtures,vec__6261,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__6264,G__6264__$1,env,once_fixtures,each_fixtures,vec__6261,ns,vars__$1){
return (function (){
var seq__6265 = cljs.core.seq.call(null,vars__$1);
var chunk__6266 = null;
var count__6267 = (0);
var i__6268 = (0);
while(true){
if((i__6268 < count__6267)){
var v = cljs.core._nth.call(null,chunk__6266,i__6268);
var temp__5735__auto___6270 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___6270)){
var t_6271 = temp__5735__auto___6270;
each_fixture_fn.call(null,((function (seq__6265,chunk__6266,count__6267,i__6268,t_6271,temp__5735__auto___6270,v,each_fixture_fn,G__6264,G__6264__$1,env,once_fixtures,each_fixtures,vec__6261,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_6271)));
});})(seq__6265,chunk__6266,count__6267,i__6268,t_6271,temp__5735__auto___6270,v,each_fixture_fn,G__6264,G__6264__$1,env,once_fixtures,each_fixtures,vec__6261,ns,vars__$1))
);
} else {
}


var G__6272 = seq__6265;
var G__6273 = chunk__6266;
var G__6274 = count__6267;
var G__6275 = (i__6268 + (1));
seq__6265 = G__6272;
chunk__6266 = G__6273;
count__6267 = G__6274;
i__6268 = G__6275;
...
var temp__5735__auto__ = cljs.core.seq.call(null,seq__6265);
if(temp__5735__auto__){
var seq__6265__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__6265__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__6265__$1);
var G__6276 = cljs.core.chunk_rest.call(null,seq__6265__$1);
var G__6277 = c__4550__auto__;
var G__6278 = cljs.core.count.call(null,c__4550__auto__);
var G__6279 = (0);
seq__6265 = G__6276;
chunk__6266 = G__6277;
count__6267 = G__6278;
...
var v = cljs.core.first.call(null,seq__6265__$1);
var temp__5735__auto___6280__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___6280__$1)){
var t_6281 = temp__5735__auto___6280__$1;
each_fixture_fn.call(null,((function (seq__6265,chunk__6266,count__6267,i__6268,t_6281,temp__5735__auto___6280__$1,v,seq__6265__$1,temp__5735__auto__,each_fixture_fn,G__6264,G__6264__$1,env,once_fixtures,each_fixtures,vec__6261,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_6281)));
});})(seq__6265,chunk__6266,count__6267,i__6268,t_6281,temp__5735__auto___6280__$1,v,seq__6265__$1,temp__5735__auto__,each_fixture_fn,G__6264,G__6264__$1,env,once_fixtures,each_fixtures,vec__6261,ns,vars__$1))
);
} else {
}


var G__6282 = cljs.core.next.call(null,seq__6265__$1);
var G__6283 = null;
var G__6284 = (0);
var G__6285 = (0);
seq__6265 = G__6282;
...
});})(each_fixture_fn,G__6264,G__6264__$1,env,once_fixtures,each_fixtures,vec__6261,ns,vars__$1))
);
});})(each_fixture_fn,G__6264,G__6264__$1,env,once_fixtures,each_fixtures,vec__6261,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__6264__$1)].join('')));

}
})());
});
;})(vec__6261,ns,vars__$1))

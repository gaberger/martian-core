...
return ((function (wrap_error,temp__5733__auto__,g,c,step){
return (function (x){
var res = step.call(null,x);
var temp__5733__auto____$1 = schema.utils.error_val.call(null,res);
...
;})(wrap_error,temp__5733__auto__,g,c,step))
} else {
return step;
}
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k6710,else__4388__auto__){
var self__ = this;
var this__4387__auto____$1 = this;
var G__6714 = k6710;
var G__6714__$1 = (((G__6714 instanceof cljs.core.Keyword))?G__6714.fqn:null);
switch (G__6714__$1) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k6710,else__4388__auto__);
...
return (function (ret__4407__auto__,p__6715){
var vec__6716 = p__6715;
var k__4408__auto__ = cljs.core.nth.call(null,vec__6716,(0),null);
var v__4409__auto__ = cljs.core.nth.call(null,vec__6716,(1),null);
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__6709){
var self__ = this;
var G__6709__$1 = this;
return (new cljs.core.RecordIter((0),G__6709__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this6711,other6712){
var self__ = this;
var this6711__$1 = this;
return (((!((other6712 == null)))) && ((this6711__$1.constructor === other6712.constructor)) && (cljs.core._EQ_.call(null,this6711__$1.pre,other6712.pre)) && (cljs.core._EQ_.call(null,this6711__$1.options,other6712.options)) && (cljs.core._EQ_.call(null,this6711__$1.err_f,other6712.err_f)) && (cljs.core._EQ_.call(null,this6711__$1.post,other6712.post)) && (cljs.core._EQ_.call(null,this6711__$1.__extmap,other6712.__extmap)));
});
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__6709){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__6719 = cljs.core.keyword_identical_QMARK_;
var expr__6720 = k__4393__auto__;
if(cljs.core.truth_(pred__6719.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__6720))){
return (new schema.spec.variant.VariantSpec(G__6709,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__6719.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__6720))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__6709,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__6719.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__6720))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__6709,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__6719.call(null,new cljs.core.Keyword(null,"post","post",269697687),expr__6720))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__6709,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4393__auto__,G__6709),null));
}
}
}
}
...
schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__6709){
var self__ = this;
var this__4384__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__6709,self__.__extmap,self__.__hash));
});
 ...
 */
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__6713){
var extmap__4424__auto__ = (function (){var G__6722 = cljs.core.dissoc.call(null,G__6713,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687));
if(cljs.core.record_QMARK_.call(null,G__6713)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__6722);
} else {
return G__6722;
}
})();
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__6713),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__6713),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__6713),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__6713),null,cljs.core.not_empty.call(null,extmap__4424__auto__),null));
});

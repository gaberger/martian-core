...
return (function (x){
var temp__5735__auto__ = (function (){try{if(cljs.core.truth_(p.call(null,x))){
return null;
} else {
return new cljs.core.Symbol(null,"not","not",1044554643,null);
}
}catch (e6675){if((e6675 instanceof Object)){
var e_SHARP_ = e6675;
...
return schema.utils.error.call(null,schema.utils.make_ValidationError.call(null,s,x,(new cljs.core.Delay(((function (reason,temp__5735__auto__){
return (function (){
return err_f.call(null,schema.utils.value_name.call(null,x));
});})(reason,temp__5735__auto__))
,null)),reason));
} else {
return null;
}
...
var temp__5733__auto__ = cljs.core.deref.call(null,cache).call(null,cache_key);
...
return wrap_recursive_delay.call(null,(new cljs.core.Delay(((function (w,temp__5733__auto__){
return (function (){
return cljs.core.deref.call(null,cache).call(null,cache_key);
});})(w,temp__5733__auto__))
,null)));
} else {
return w;
}
 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__6676,p__6677){
...
var schema__$1 = cljs.core.get.call(null,map__6678__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var error_wrap = cljs.core.get.call(null,map__6678__$1,new cljs.core.Keyword(null,"error-wrap","error-wrap",-1295833514));
var map__6679 = p__6677;
var map__6679__$1 = (((((!((map__6679 == null))))?(((((map__6679.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6679.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6679):map__6679);
var params = map__6679__$1;
var subschema_checker = cljs.core.get.call(null,map__6679__$1,new cljs.core.Keyword(null,"subschema-checker","subschema-checker",1137701360));
var cache = cljs.core.get.call(null,map__6679__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var sub = schema.spec.core.with_cache.call(null,cache,schema__$1,((function (map__6678,map__6678__$1,schema__$1,error_wrap,map__6679,map__6679__$1,params,subschema_checker,cache){
return (function (d){
return ((function (map__6678,map__6678__$1,schema__$1,error_wrap,map__6679,map__6679__$1,params,subschema_checker,cache){
return (function (x){
return cljs.core.deref.call(null,d).call(null,x);
});
;})(map__6678,map__6678__$1,schema__$1,error_wrap,map__6679,map__6679__$1,params,subschema_checker,cache))
});})(map__6678,map__6678__$1,schema__$1,error_wrap,map__6679,map__6679__$1,params,subschema_checker,cache))
,((function (map__6678,map__6678__$1,schema__$1,error_wrap,map__6679,map__6679__$1,params,subschema_checker,cache){
return (function (){
return subschema_checker.call(null,schema__$1,params);
});})(map__6678,map__6678__$1,schema__$1,error_wrap,map__6679,map__6679__$1,params,subschema_checker,cache))
);
if(cljs.core.truth_(error_wrap)){
return ((function (sub,map__6678,map__6678__$1,schema__$1,error_wrap,map__6679,map__6679__$1,params,subschema_checker,cache){
return (function (x){
var res = sub.call(null,x);
var temp__5733__auto__ = schema.utils.error_val.call(null,res);
if(cljs.core.truth_(temp__5733__auto__)){
...
;})(sub,map__6678,map__6678__$1,schema__$1,error_wrap,map__6679,map__6679__$1,params,subschema_checker,cache))
} else {
return sub;
}
});

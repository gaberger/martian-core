...
var G__6684 = cljs.core.first.call(null,e);
...
return ((function (_,c,G__6684,G__6684__$1){
return (function (res,x){
cljs.core.swap_BANG_.call(null,res,cljs.core.into,cljs.core.map.call(null,c,x));

return then.call(null,res,null);
});
;})(_,c,G__6684,G__6684__$1))

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__6684__$1)].join('')));
...
if(cljs.core.not_any_QMARK_.call(null,(function (p1__6686_SHARP_){
return ((cljs.core.vector_QMARK_.call(null,p1__6686_SHARP_)) && (cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__6686_SHARP_),new cljs.core.Keyword("schema.spec.collection","remaining","schema.spec.collection/remaining",-421177821))));
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k6688,else__4388__auto__){
var self__ = this;
var this__4387__auto____$1 = this;
var G__6692 = k6688;
var G__6692__$1 = (((G__6692 instanceof cljs.core.Keyword))?G__6692.fqn:null);
switch (G__6692__$1) {
case "pre":
return self__.pre;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k6688,else__4388__auto__);
...
return (function (ret__4407__auto__,p__6693){
var vec__6694 = p__6693;
var k__4408__auto__ = cljs.core.nth.call(null,vec__6694,(0),null);
var v__4409__auto__ = cljs.core.nth.call(null,vec__6694,(1),null);
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__6687){
var self__ = this;
var G__6687__$1 = this;
return (new cljs.core.RecordIter((0),G__6687__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"constructor","constructor",-1953928811),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this6689,other6690){
var self__ = this;
var this6689__$1 = this;
return (((!((other6690 == null)))) && ((this6689__$1.constructor === other6690.constructor)) && (cljs.core._EQ_.call(null,this6689__$1.pre,other6690.pre)) && (cljs.core._EQ_.call(null,this6689__$1.constructor,other6690.constructor)) && (cljs.core._EQ_.call(null,this6689__$1.elements,other6690.elements)) && (cljs.core._EQ_.call(null,this6689__$1.on_error,other6690.on_error)) && (cljs.core._EQ_.call(null,this6689__$1.__extmap,other6690.__extmap)));
});
...
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__4395__auto__)),null));
}
});

schema.spec.collection.CollectionSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__6687){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__6697 = cljs.core.keyword_identical_QMARK_;
var expr__6698 = k__4393__auto__;
if(cljs.core.truth_(pred__6697.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__6698))){
return (new schema.spec.collection.CollectionSpec(G__6687,self__.constructor$,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__6697.call(null,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),expr__6698))){
return (new schema.spec.collection.CollectionSpec(self__.pre,G__6687,self__.elements,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__6697.call(null,new cljs.core.Keyword(null,"elements","elements",657646735),expr__6698))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,G__6687,self__.on_error,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__6697.call(null,new cljs.core.Keyword(null,"on-error","on-error",1728533530),expr__6698))){
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,G__6687,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4393__auto__,G__6687),null));
}
}
}
}
...
schema.spec.collection.CollectionSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__6687){
var self__ = this;
var this__4384__auto____$1 = this;
return (new schema.spec.collection.CollectionSpec(self__.pre,self__.constructor$,self__.elements,self__.on_error,G__6687,self__.__extmap,self__.__hash));
});
 ...
 */
schema.spec.collection.map__GT_CollectionSpec = (function schema$spec$collection$map__GT_CollectionSpec(G__6691){
var extmap__4424__auto__ = (function (){var G__6700 = cljs.core.dissoc.call(null,G__6691,new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"constructor","constructor",-1953928811),new cljs.core.Keyword(null,"elements","elements",657646735),new cljs.core.Keyword(null,"on-error","on-error",1728533530));
if(cljs.core.record_QMARK_.call(null,G__6691)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__6700);
} else {
return G__6700;
}
})();
return (new schema.spec.collection.CollectionSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__6691),new cljs.core.Keyword(null,"constructor","constructor",-1953928811).cljs$core$IFn$_invoke$arity$1(G__6691),new cljs.core.Keyword(null,"elements","elements",657646735).cljs$core$IFn$_invoke$arity$1(G__6691),new cljs.core.Keyword(null,"on-error","on-error",1728533530).cljs$core$IFn$_invoke$arity$1(G__6691),null,cljs.core.not_empty.call(null,extmap__4424__auto__),null));
});
...
/** @this {Function} */
schema.spec.collection.optional.cljs$lang$applyTo = (function (seq6702){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq6702));
});
